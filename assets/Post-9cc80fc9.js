...
`,d=()=>a.jsxs("div",{className:"relative min-h-screen bg-black flex justify-center",children:[a.jsx("div",{className:"fixed w-full h-screen bg-[url('/bg_login.jpg')] opacity-20"}),a.jsxs("div",{className:"relative z-10 w-full max-w-2xl bg-slate-950/70 text-neutral-300 px-5 pt-10 pb-20",children:[a.jsx(s,{to:"/",children:"Voltar"}),a.jsxs("div",{className:"flex items-center gap-5 mt-10",children:[a.jsx("div",{className:"h-24 w-24 rounded-full bg-white"}),a.jsxs("div",{children:[a.jsx("h1",{className:"text-lg font-bold",children:"Lucas Maia"}),a.jsx("p",{className:"text-neutral-400",children:"Lucas Maia"}),a.jsx("p",{className:"text-neutral-400",children:"16 de setembro de 2023 (editado)"})]})]}),a.jsx("h1",{className:"text-2xl font-bold overflow-auto mt-5",children:"A Lenda da Mulher da Floresta"}),a.jsx("h2",{className:"mt-5 text-sm opacity-70",children:"Lendas de Deuses e Espíritos • Lendas de Encantamento"}),a.jsx("div",{className:"mt-7",children:o(t)})]})]});export{d as default};
